                                        ...
                                        <div class="left-part">
                                            <div class="date-time-block">
                                                ...
                                                <ul class="time-slot date">
                                                    <li data-date="<?php echo e(date('m-d-Y')); ?>"><?php echo e(date('m/d/Y')); ?></li>
                                                    <?php for($i=1; $i <10; $i++): ?>
                                                        <li data-date="<?php echo e(date('d-m-Y',strtotime("+".$i." day"))); ?>"><?php echo e(date('m/d/Y',strtotime("+".$i." day"))); ?></li>
                                                    <?php endfor; ?>
                                                </ul>
                                            </div>
                                            <div class="date-time-block">
                                                        ...
                                                        <nav>
                                                            <div class="nav nav-tabs" role="tablist">
                                                               ...
                                                               <!--     <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab"  aria-selected="true"><i class="fas fa-user"></i></a>-->
                                                                <?php endif; ?>
                                                                <a class="nav-item nav-link  <?php if(auth()->check()): ?> active <?php else: ?>  <?php endif; ?>"  id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"><i class="fas fa-address-book"></i></a>
                                                        ...
                                                        <div class="tab-content" >
                                                            <?php if(!auth()->guard('web')->check()): ?>
                                                                <div class="tab-pane fade" id="nav-home" role="tabpanel">
                                                                    ...
                                                                    <div class="checkout-type margin-bottom-30  <?php if(auth()->guard('web')->check()): ?>  <?php endif; ?> ">
                                                                    ...
                                                                    <?php if(!auth()->guard('web')->check()): ?>
                                                                        <div class="next-step">
                                                                            <button class="next-step-btn btn-boxed" style= type="button"><?php echo e(__('Next Step')); ?></button>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                </div>
                                                            <?php endif; ?>
                                                            <div class="tab-pane fade show active <?php if(auth()->guard('web')->check()): ?>  <?php endif; ?>" id="nav-profile" role="tabpanel">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7-2\htdocs\projects\truefamilycareclinic-com\site\core\@core\resources\views/frontend/pages/appointment/single.blade.php ENDPATH**/ ?>