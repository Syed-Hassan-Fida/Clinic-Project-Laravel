...
<div class="header-slider-wrapper">
    ...
    <h1 class="title">
        <?php
        $title = filter_static_option_value('medical_home_page_header_'.$user_select_lang_slug.'_title',$static_field_data);
        $titleWords = explode(' ', $title);
        $lineLength = 3;
        $lines = array_chunk($titleWords, $lineLength);
            ...
            <div class="col-lg-12">
                <div class="appointment-inner-area">
                    <div class="left-content-area">
                        ...
                        <h5 class="helpline">
    <?php
        $hotline = filter_static_option_value('medical_cta_area_section_'.$user_select_lang_slug.'_hotline',$static_field_data);
        $hotlineWords = explode(' ', $hotline);
        $lineLength = 3;
        $lines = array_chunk($hotlineWords, $lineLength);
        foreach ($lines as $line) {
            echo implode(' ', $line) . '<br>';
        }
    ?>
...
<?php /**PATH C:\xampp7-2\htdocs\projects\wetransfer_truefamilycareclinic-com-zip_2024-03-04_1909\truefamilycareclinic.com\truefamilycareclinic.com\@core\resources\views/frontend/home-pages/home-12.blade.php ENDPATH**/ ?>