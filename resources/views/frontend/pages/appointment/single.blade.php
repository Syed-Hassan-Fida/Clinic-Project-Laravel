                                        ...
                                        <div class="left-part">
                                            <div class="date-time-block">
                                                ...
                                                <ul class="time-slot date">
                                                    <li data-date="{{date('m-d-Y')}}">{{date('m/d/Y')}}</li>
                                                    @for($i=1; $i <10; $i++)
                                                        <li data-date="{{date('d-m-Y',strtotime("+".$i." day"))}}">{{date('m/d/Y',strtotime("+".$i." day"))}}</li>
                                                    @endfor
                                                </ul>
                                            </div>
                                            <div class="date-time-block">
                                                        ...
                                                        <nav>
                                                            <div class="nav nav-tabs" role="tablist">
                                                               ...
                                                               <!--     <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab"  aria-selected="true"><i class="fas fa-user"></i></a>-->
                                                                @endif
                                                                <a class="nav-item nav-link  @if(auth()->check()) active @else  @endif"  id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"><i class="fas fa-address-book"></i></a>
                                                        ...
                                                        <div class="tab-content" >
                                                            @if(!auth()->guard('web')->check())
                                                                <div class="tab-pane fade" id="nav-home" role="tabpanel">
                                                                    ...
                                                                    <div class="checkout-type margin-bottom-30  @if(auth()->guard('web')->check())  @endif ">
                                                                    ...
                                                                    @if(!auth()->guard('web')->check())
                                                                        <div class="next-step">
                                                                            <button class="next-step-btn btn-boxed" style= type="button">{{__('Next Step')}}</button>
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                            @endif
                                                            <div class="tab-pane fade show active @if(auth()->guard('web')->check())  @endif" id="nav-profile" role="tabpanel">
